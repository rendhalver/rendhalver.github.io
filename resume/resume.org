...
- Infrastructure tools (Kubernetes, Containers, AWS, and Azure)
...
Red Hat is an Open Source software business that maintains and donfributes to many Open Source products.
They provide support for those products as well.
My time at Red hat was spent on the SRE Platform team supporting Managed OpenShift clusters for many large and well known businesses.

Responsibilities
- Contribute code to increase the scalability and reliability of the service
- Contribute software tests and participate on peer review to increase the quality of the code base
- Help and develop peers' capabilities through knowledge sharing, mentoring, and collaboration
- Participate in regular on-call schedule, including occasional paid weekends and holidays
- Practice sustainable incident response and blameless postmoretems
- Resolve customer issues escalated from our Global Support team
- Work within a small agile team to develop and improve SRE software, support your peers, plan, and improve my skills

Achievements
- Spent a year as Region Lead six months after starting role
- Implemented many improvements to the Ops Review Meeting
- Helped implement a major change in monitoring system for a new Red Hat product
- Member of the global leadership council for Mental Health and Neurodiversity
...
Responsibilities
- Rebuilding server infrastructure into an automated and managed environment with Puppet, Containers and OpenStack
- Managing OpenStack
- Writing puppet modules to manage all the company’s services
- Write Containers images for selected services
- Managing and maintaining an Ubuntu and CentOS Linux server infrastructure with Puppet/Containers and OpenStack.
